...
class CLevelThreeContactListener : public b2ContactListener
{
public:
	...
	bool _bDeleteCar;
	//
	cocos2d::Sprite* _targetBallSprite;
	int countball;
	bool _bAddBall;
	//刪除子彈
	bool _bDeleteBullet;
	...
	b2Body* deleteBody;
	int _iBodyNum;
	CLevelThreeContactListener();
	//碰撞開始
	virtual void BeginContact(b2Contact* contact);
	//碰撞結束
	//virtual void EndContact(b2Contact* contact);
	void setCollisionTarget(cocos2d::Sprite& targetSprite);
	void setCollisionTarget02(cocos2d::Sprite& targetSprite);
};
...
public:
	...
	//碰撞
	CLevelThreeContactListener _contactListener;
